...
import com.trevisol.habittracker.data.repository.HabitRecordRepositoryImpl
...
class HabitApplication: Application() {
    ...
    val habitRecordRepository by lazy { HabitRecordRepositoryImpl(database.habitRecordDao()) }
}